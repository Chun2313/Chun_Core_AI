...
┃ ┣ 📁 assets/css/main.css -> Cấu hình Tailwind CSS toàn cục
┃ ┗ 📁 pages/
...
┣ 📁 server/api/chat.post.ts -> API Endpoint nhận message, gọi Google Gemini SDK
...
<div align="center">
  🌟 Đừng quên tặng dự án 1 Star trên GitHub nếu bạn yêu thích Trợ lý Chún Tiên Tri nhé! 🌟
</div>
